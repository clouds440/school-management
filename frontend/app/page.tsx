      ...
      <section className="relative pt-12 pb-16 md:pt-32 md:pb-40 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
            <Reveal>
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 text-primary text-xs md:text-sm font-bold mb-4 tracking-wide uppercase">
            ...
            <Reveal delay={100}>
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight text-gray-900 leading-[1.1] md:leading-tight">
                Empower Your Institution with <Brand showLogo={false} useGradient size="hero" />
              </h1>
            </Reveal>
