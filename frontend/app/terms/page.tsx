    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-40 bg-gray-50/50 border-b border-gray-100">
        <div className="container mx-auto px-6 text-center max-w-4xl space-y-6">
          <Reveal>
            <CheckCircle className="w-16 h-16 text-primary mx-auto mb-8 bg-white p-4 rounded-3xl shadow-sm border border-gray-100" />
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight leading-tight uppercase">Terms of Service</h1>
          </Reveal>
          <Reveal delay={200}>
          ...
          <Reveal delay={400}>
            <div className="flex items-center justify-center space-x-2 text-xs font-black text-gray-400 uppercase tracking-widest">
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-6 max-w-4xl prose prose-slate prose-lg">
          <Reveal>
            <h2 className="text-3xl font-black text-gray-900 mb-8 border-b border-gray-100 pb-4">1. Acceptance of Terms</h2>
          ...
          <Reveal delay={100}>
            <h2 className="text-3xl font-black text-gray-900 mb-8 border-b border-gray-100 pb-4">2. Subscription & Payments</h2>
            <p className="text-gray-600 font-medium leading-relaxed mb-12">
          ...
          <Reveal delay={200}>
            <h2 className="text-3xl font-black text-gray-900 mb-8 border-b border-gray-100 pb-4">3. User Responsibility & Code of Conduct</h2>
            <p className="text-gray-600 font-medium leading-relaxed mb-12">
