            ...
            <div className="flex-1 space-y-8 animate-fade-in-up">
                {(orgStatus || user.status) === 'PENDING' && (
                    <div className="flex flex-col items-center justify-center p-12 bg-white/70 backdrop-blur-md rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] border border-white/40 text-center max-w-2xl mx-auto mt-10 hover:shadow-2xl transition-all duration-500 hover:scale-[1.01]">
                        ...
                        <div className="bg-yellow-100 text-yellow-800 px-10 py-5 rounded-3xl font-black text-xl border border-yellow-200 w-full shadow-inner flex items-center justify-center gap-3">
                ...
                {(orgStatus || user.status) === 'REJECTED' && (
                    <div className="flex flex-col items-center justify-center p-12 bg-white/70 backdrop-blur-md rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] border border-white/40 text-center max-w-2xl mx-auto mt-10 hover:shadow-2xl transition-all duration-500 hover:scale-[1.01]">
                        ...
                        <div className="bg-red-50 border border-red-100 p-6 rounded-3xl mb-8 text-left w-full shadow-inner">
                            <p className="text-xs font-bold text-red-400 uppercase tracking-widest mb-2 font-black">Institutional Notice</p>
                ...
                {(orgStatus || user.status) === 'SUSPENDED' && (
                    <div className="flex flex-col items-center justify-center p-12 bg-white/70 backdrop-blur-md rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.2)] border border-orange-200 text-center max-w-2xl mx-auto mt-10 hover:shadow-2xl transition-all duration-500 hover:scale-[1.01]">
                        ...
                        <div className="bg-orange-50 text-orange-800 p-6 rounded-3xl border border-orange-100 w-full mb-8 text-left shadow-inner">
                            <h3 className="font-bold mb-2 flex items-center gap-2 text-sm uppercase tracking-wider text-orange-900/60 font-black"><AlertTriangle className="w-4 h-4" /> Important Message</h3>
