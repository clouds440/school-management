    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-40 bg-gray-50/50 border-b border-gray-100">
        <div className="container mx-auto px-6 text-center max-w-4xl space-y-6">
          <Reveal>
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight leading-tight">Insightful Articles for <span className="text-primary">Modern Educators</span></h1>
          </Reveal>
          <Reveal delay={200}>
      ...
      <section className="py-24 md:py-32 bg-primary/5 border-y border-primary/10">
        <div className="container mx-auto px-6 max-w-3xl text-center space-y-8">
          <Reveal>
            <h2 className="text-3xl font-black text-gray-900">Stay Ahead of the Curve</h2>
          </Reveal>
          <Reveal delay={200}>
          ...
          <Reveal delay={400}>
            <div className="flex flex-col sm:flex-row gap-4 p-2 bg-white rounded-2xl shadow-xl shadow-primary/5 border border-gray-100">
              <input
                type="email"
                placeholder="Enter your work email"
                className="flex-1 px-6 py-4 rounded-xl text-gray-900 border-none focus:outline-none focus:ring-0 font-medium"
              />
  ...
  return (
    <Reveal delay={delay}>
      <div className="group cursor-pointer space-y-6 h-full flex flex-col">
        <div className="aspect-video bg-gray-100 rounded-3xl overflow-hidden relative border border-gray-100 shadow-sm transition-all duration-500 group-hover:shadow-xl group-hover:scale-[1.02]">
          <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full text-xs font-black text-primary uppercase tracking-widest border border-gray-100 shadow-sm">
            {category}
          </div>
        ...
        <div className="space-y-4 flex-1 flex flex-col">
          ...
          <h3 className="text-2xl font-black text-gray-900 leading-tight group-hover:text-primary transition-colors">{title}</h3>
          <p className="text-gray-500 font-medium leading-relaxed flex-1">{excerpt}</p>
          <div className="pt-2">
