...
export default function CareersPage() {
  return (
    <div className="flex flex-col bg-white">
      {/* Hero */}
      <section className="pt-24 pb-16 md:pt-32 md:pb-40 bg-gray-900 overflow-hidden relative border-b border-white/5">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 -left-1/4 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-primary/20 rounded-full blur-3xl animate-pulse" />
        </div>
        <div className="container mx-auto px-6 text-center max-w-4xl space-y-6 relative z-10">
          <Reveal>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 text-white text-xs font-bold mb-4 tracking-wide uppercase border border-white/10 backdrop-blur-md">
              Join the Mission
            </div>
          </Reveal>
          <Reveal delay={200}>
            <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-tight">Help Us Build the <span className="text-primary bg-clip-text bg-linear-to-r from-primary via-indigo-400 to-purple-400">Future of Education</span></h1>
          </Reveal>
          <Reveal delay={400}>
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            <Reveal>
              <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tighter uppercase">Why {PLATFORM_NAME}?</h2>
            </Reveal>
            <Reveal delay={200}>
              <p className="text-gray-500 text-lg font-medium">Life is better when you build something that matters.</p>
            </Reveal>
          </div>
            ...
            {[
              ...
              <Reveal key={i} delay={i * 200}>
                <div className="space-y-6 group cursor-default">
                  <div className="w-16 h-16 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform group-hover:shadow-lg group-hover:border-primary/20">
                    {v.icon}
                  </div>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="space-y-4 max-w-xl">
              <Reveal>
                <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tighter uppercase">Open Roles</h2>
              </Reveal>
              <Reveal delay={200}>
            ...
            <Reveal delay={400}>
              <div className="relative w-full md:w-80">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 ring-primary/20 font-medium"
                />
              </div>
            </Reveal>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <Reveal key={i} delay={i * 100}>
                <div className="group bg-white p-6 md:p-8 rounded-3xl border border-gray-100 hover:border-primary/30 transition-all hover:shadow-xl hover:shadow-primary/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                  ...
                  <Link href="/contact" className="w-full md:w-auto px-8 py-4 bg-gray-900 text-white rounded-xl font-bold hover:bg-primary transition-all text-center">
                    Apply Now
                  </Link>
                </div>
              </Reveal>
          ...
          <div className="mt-20 text-center">
            <Reveal delay={500}>
              <p className="text-gray-500 font-medium mb-8">Don't see a role that fits? We're always looking for talent.</p>
