            ...
            {[
              ...
              <Reveal key={i} delay={i * 200}>
                <div className="space-y-6 group cursor-default">
                  <div className="w-16 h-16 rounded-2xl bg-card border border-border flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform group-hover:shadow-lg group-hover:border-primary/20">
                    {v.icon}
                  </div>
